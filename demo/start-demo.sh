#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# AI Predictor & Auto-Healer — Hackathon Demo Starter
# ─────────────────────────────────────────────────────────────────────────────
set -euo pipefail

echo "🎬 Starting AI Predictor & Auto-Healer Demo Setup..."
echo ""

# Check if healer is deployed
if ! kubectl get deployment ai-predictor-healer -n ai-healer-system >/dev/null 2>&1; then
  echo "❌ AI Predictor & Auto-Healer is not deployed yet."
  echo ""
...
echo "   kubectl logs -f deployment/ai-predictor-healer -n ai-healer-system --tail=50"
echo ""
echo "════════════════════════════════════════════════════════════════════════════"
echo ""
